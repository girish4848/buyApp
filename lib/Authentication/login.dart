...
class _LoginState extends State<Login> {
  ...
  Future readData(User fUser) async {
    FirebaseFirestore.instance
      ...
      await EcommerceApp.sharedPreferences.setString(EcommerceApp.contactNumber,
          dataSnapshot.data()[EcommerceApp.contactNumber]);
      await EcommerceApp.sharedPreferences.setString(
          EcommerceApp.address, dataSnapshot.data()[EcommerceApp.address]);
    });
  }
}
